...
from services.scraper import general_recommendation_scraper
from services.search_service import SearchService
...
def course_recommendations(program_catalog_number):
    try:
        sections = current_user.planned_sections
        recommendation_map = general_recommendation_scraper(program_catalog_number)
        recommended_courses = []
        course_codes = []
        ...
        for s in sections:
            ...
            if course_code in recommendation_map:
